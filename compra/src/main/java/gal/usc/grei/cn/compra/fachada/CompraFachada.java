package gal.usc.grei.cn.compra.fachada;

import gal.usc.grei.cn.compra.modelo.Compra;
import gal.usc.grei.cn.compra.repositorio.CompraRepositorio;
...
// Se recupera la compra por el id
    ...
    public Optional<Compra> create(Compra compra) throws RuntimeException{
        ...
        String servicioCompraUrl = "http://localhost:8082/Servicios/realizarCompra";
